...
package de.florianreuth.classic4j;
...
import de.florianreuth.classic4j.model.classicube.server.CCServerList;
import de.florianreuth.classic4j.request.classicube.auth.CCAuthenticationLoginRequest;
import de.florianreuth.classic4j.request.classicube.auth.CCAuthenticationTokenRequest;
import de.florianreuth.classic4j.request.classicube.server.CCServerInfoRequest;
import de.florianreuth.classic4j.request.classicube.server.CCServerListRequest;
import de.florianreuth.classic4j.util.HttpClientUtils;
import java.net.URI;
